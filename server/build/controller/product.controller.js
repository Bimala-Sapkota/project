...
const cloudinary_conflict_1 = require("../config/cloudinary.conflict.");
...
exports.update = (0, async_handler_utils_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (coverImage) {
        if (product.coverImage) {
            yield (0, cloudinary_conflict_1.removeImages)([product.coverImage.public_id]);
        }
        product.coverImage = {
            path: coverImage[0].path,
            public_id: coverImage[0].filename,
    ...
    if (Array.isArray(deletedImage) && deletedImage.length > 0) {
        yield (0, cloudinary_conflict_1.removeImages)(deletedImage);
        if (product.images) {
            product.images =
...
exports.remove = (0, async_handler_utils_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (product.images && product.images.length > 0) {
        ...
        yield (0, cloudinary_conflict_1.removeImages)(imageIds);
    }
    // 3. delete product
